...
class Actor(nn.Module):
	def __init__(self, state_dim, action_dim, max_action, phi=0.05):
		...
		self.l1_1 = nn.Linear(400, 400)
		self.l1_2 = nn.Linear(400, 400)  
		self.l1_3 = nn.Linear(400, 400) 
...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim):
		...
		self.l4_1 = nn.Linear(400, 400)
		self.l4_2 = nn.Linear(400, 400)
		self.l4_3 = nn.Linear(400, 400) 
	...
	def forward(self, state, action):
		...
		q2 = F.relu(self.l4_2(q2))
		q2 = F.relu(self.l4_3(q2))
...
class VAE(nn.Module):
	def __init__(self, state_dim, action_dim, latent_dim, max_action, device):
		...
		self.e4 = nn.Linear(750, 750)
		self.e5 = nn.Linear(750, 750)
		...
		self.d2_1 = nn.Linear(750, 750)
		self.d2_2 = nn.Linear(750, 750)
		self.d2_3 = nn.Linear(750, 750)
	...
	def decode(self, state, z=None):
		...
		a = F.relu(self.d2(a))
		a = F.relu(self.d2_1(a))
		a = F.relu(self.d2_2(a))
		a = F.relu(self.d2_3(a))
